/**
* \file tuile.h
* \brief Ce fichier contient la description des types :
 ...
 * \brief Tourne une tuile un certain nombre de fois d'un quart de tour dans le sens trigonométrique
 * \param t La tuile à tourner
 * \param fois le nombre de fois où il faut la tourner 
 */
void tourner_tuile(Tuile t, int fois);
